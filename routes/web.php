...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/task/{task}/comments', [TaskController::class, 'storeComments'])->name('comments.store');
    ...
    Route::delete('/attachment/{attachment}', [ProjectController::class, 'fileDestroy'])->name('fileDestroy');

    /* SOLO GLI UTENTI ADMIN E PROJECT MANAGER POSSO FARE DETERMINATE COSE */
    Route::middleware(['check.user.role:Admin/PI'])->group(function () {
        ...
        Route::delete('/comments/{comment}', [TaskController::class, 'destroyComments'])->name('destroyComments');
